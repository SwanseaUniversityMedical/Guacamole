...
class CustomObjectsApi(k8s.client.CustomObjectsApi):
    ...
    def list_namespaced_custom_object_with_http_info(self, group, version, namespace, plural, **kwargs):  # noqa: E501
        ...
        :param send_initial_events: sendInitialEvents determines how resourceVersionMatch is applied to list calls. It is highly recommended that resourceVersionMatch be set for list calls where resourceVersion is set See https://kubernetes.io/docs/reference/using-api/api-concepts/#resource-versions for details.  Defaults to unset
